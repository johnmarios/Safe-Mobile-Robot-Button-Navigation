# Mechanical adaptation of controller0.py for Button2.
# Controller logic and default parameters are unchanged.
...
class Button2Controller:
    """
    Reactive lidar controller for SafetyRacecarButton2-v0.
