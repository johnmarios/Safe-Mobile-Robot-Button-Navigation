...
from evaluate.evaluate_sac_turn_pen import evaluate_policy_turn_pen
from render.render_sac import render_policy
from config import *

def train_1(MAX_TIMESTEPS,
            START_TIMESTEPS,
            LOAD_MODEL,
            LOAD_RESULTS_PATH,
    ...
    for t in range(MAX_TIMESTEPS):
        ...
        # Reward shaping
        modified_reward = reward - COST_WEIGHT * cost - turn_penalty
        ...
        if (
            ...
            avg_reward, avg_cost, avg_turn_penalty, eval_rewards_history_r, eval_costs_history_r, eval_turn_penalty_h = evaluate_policy_turn_pen(
                agent,
                TURNING_WEIGHT,
                env_name=ENV_NAME,
